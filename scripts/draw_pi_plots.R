...
TD5<-read.table("/Users/simonrenny-byfield/test_angst/5/teosinte20thetas.gz.pestPG",header=T)
TD10<-read.table("/Users/simonrenny-byfield/test_angst/10/teosinte20thetas.gz.pestPG",header=T)
TD15<-read.table("/Users/simonrenny-byfield/test_angst/15/teosinte20thetas.gz.pestPG",header=T)
TD20<-read.table("/Users/simonrenny-byfield/test_angst/20/teosinte20thetas.gz.pestPG",header=T)
