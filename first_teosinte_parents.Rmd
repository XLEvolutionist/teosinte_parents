...
N_SITES="$((`zcat teoparents20.mafs.gz | wc -l`-1))"
echo $N_SITES

cmd1="ngsF -n_ind 20 -n_sites $N_SITES  -min_epsilon 1e-5 -glf teo_parents20.glf -out teo_parents20.approx_indF -approx_EM -seed 12345 -init_values -n_threads 8"
echo $cmd1
eval $cmd1

cmd2="ngsF -n_ind 20 -n_sites $N_SITES -min_epsilon 1e-9 -glf teo_parents20.glf -out teo_parents20.indF -init_values teo_parents20.approx_indF.pars -n_threads 8"
echo $cmd2
eval $cmd2
